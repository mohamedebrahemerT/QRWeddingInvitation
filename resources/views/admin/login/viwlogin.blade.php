...
<html lang="en" dir="rtl">
    ...
    <body class=" login" style="background-color: #fff !important;">
        ...
        <div class="logo">
            <a href="{{url('/')}}/">
                <img src="{{url('/')}}/{{setting()->logo}}" alt=""  style="height: 100px;" /> </a>
 <h5 class="form-title font-green" style="color:#33509e !important" >{{setting()->name}}</h5>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
   ...
   @endif
                <h3 class="form-title font-green" style="color:#33509e !important" >{{trans('trans.Sign In')}}</h3>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="{{trans('trans.email')}}" name="username" /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">{{trans('trans.Password')}}</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="{{trans('trans.Password')}}" name="password" /> </div>
                <div class="form-actions">
                    <button type="submit" class="btn green uppercase"  style="background-color: #237bf6">{{trans('trans.Login')}}</button>
                ...
                <!--div class="create-account" style="background-color: #237bf6">
            <p >
                <a href="{{url('/')}}/companies_login" id="register-btn" class="uppercase" > {{trans('trans.companies login')}}</a>
            </p>
        </div -->
            ...
            <form class="forget-form" action="{{url('/')}}/admin/password/forget" method="post"> 
                ...
                <div class="form-group">
                    <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="{{trans('trans.email')}}" name="email" /> </div>
                <div class="form-actions">
                    <button  type="button" id="back-btn" class="btn green btn-outline" style="background-color: #237bf6">{{trans('trans.Back')}}</button>
                    <button type="submit" class="btn btn-success uppercase pull-right" style="background-color: #237bf6">{{trans('trans.Submit')}}</button>
                </div>
            </form>
